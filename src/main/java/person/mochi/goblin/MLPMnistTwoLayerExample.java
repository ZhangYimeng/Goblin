...
import person.mochi.goblin.dataset.MongoDBDataSetIterator;
//import person.mochi.goblin.lookinto.MnistDataSetIterator;
 ...
 * rectified linear unit (relu) activation function. The weights for this layer
 * are also initialized by using Xavier initialization
 * (https://prateekvjoshi.com/2016/03/29/understanding-xavier-initialization-in-deep-neural-networks/)
 ...
 * input layer. The weights for this layer is also initialized using Xavier
...
//		DataSetIterator mnistTest = new MnistDataSetIterator(batchSize, false, rngSeed);
		...
		DataSetIterator mnistTrain = new MongoDBDataSetIterator(batchSize, 60000, "127.0.0.1", 27017, "mochi", "gotohellmyevilex", "Yihan", "ImageDataForTest", 10, 0, 60000);
