...
public class MochiDataSetFetcher3 extends BaseDataFetcher {
	...
	public MochiDataSetFetcher3() {
		try {
			...
			MongoDBConfigWithAuth confNegatives = new MongoDBConfigWithAuth("127.0.0.1", 27017, "mochi",
					"gotohellmyevilex", new String[] { "data", "articleId" }, null);
			playerArticles = new MongoDBPlayer(confArticles, "Yizhuo", "ArticlesForPredict");
			playerPositives = new MongoDBPlayer(confPositives, "Yizhuo", "PositivesForPredict");
			playerNegatives = new MongoDBPlayer(confNegatives, "Yizhuo", "NegativesForPredict");
