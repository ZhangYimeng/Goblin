...
import person.mochi.goblin.lookinto.FileSplit;
...
public class ModelZooTest {
	private static final Logger log = LoggerFactory.getLogger(ModelZooTest.class);
	...
	public static void main(String[] args) throws java.lang.Exception {
		...
		// This "DataSetType" is enum.
		File trainDir = fetcher.getDataSetPath(DataSetType.TRAIN);
		System.out.println(FileUtils.listFiles(trainDir, null, true));
		...
		if (new File(modelFilename).exists()) {
			...
			FineTuneConfiguration fineTuneConf = (new FineTuneConfiguration.Builder().seed(seed)
					...
					.l2(0.00001).activation(Activation.IDENTITY)).trainingWorkspaceMode(WorkspaceMode.SEPARATE)
